...
namespace WebApp.Pages.Home
{
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(IProfileService profileService) // Inject IProfileService qua constructor
        {
        ...
        {
            var item = await _profileService.Register(username, password, email, "Customer");
            if (item == false)
            {
